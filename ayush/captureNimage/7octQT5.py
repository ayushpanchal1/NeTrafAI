...
import os
import matplotlib
matplotlib.use('QtAgg')  # Change to QtAgg backend
...
class NetworkCaptureApp(QWidget):
    ...
    def update_image(self):
        ...
        # Update protocol counts and plot
        self.update_protocol_counts()

    def update_protocol_counts(self):
        protocol_counts = defaultdict(int)
        
        # Count the packets in the packet_buffer
        with self.packet_buffer_lock:
        ...
        # Create a bar graph
        self.plot_protocol_counts(protocol_counts)

    def plot_protocol_counts(self, protocol_counts):
        plt.bar(protocol_counts.keys(), protocol_counts.values(), color=['blue', 'green', 'red'])
